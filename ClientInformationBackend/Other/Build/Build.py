...
def build():
    ...
    t.standardized_tasks_build_for_dotnet_project(buildscript_file, default_target_environment_type, t.get_default_target_environmenttype_mapping(), [runtime], verbosity,  commandline_args)
